...
function createWindowLifecycle(options) {
  ...
  function buildApplicationMenu() {
    ...
    // own 42px header acting as the title bar, so the
    // File/Edit/View/Connection/Window/Help bar is removed entirely. The
    // template is still built (registering the accelerators) either way; only
    // macOS installs it as the visible application menu.
    if (IS_MAC) {
