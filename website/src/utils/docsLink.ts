...
// RoyCrew fork: this fork's own repo, not upstream's. Upstream extracted this
// helper out of TipCard, and taking that refactor verbatim would have pointed
// every in-app docs link at kirodotdev/KiroCrew -- a tree whose docs/ may not
// match what this build actually ships.
