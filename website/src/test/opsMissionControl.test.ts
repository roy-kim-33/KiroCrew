 ...
 * the app never produced one, so the ONE push channel RoyCrew offers that needs no
...
describe('Settings surfaces the notification channels and their on/off', () => {
  ...
  it('points at the central rail instead of duplicating per-channel mute', () => {
    // RoyCrew stores per-channel mute centrally; a second control here would be two
