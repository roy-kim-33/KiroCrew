    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "Use AFTER calling browser op='snapshot' to reduce a large accessibility "
                "tree (50-100K tokens) into a navigable outline (~2-5K tokens). "
            ...
            "inputSchema": {
                ...
                "properties": {
                    "snapshot": {
                        "type": "string",
                        "description": "The raw snapshot output text to compress",
                    },
                    "max_lines": {
                        "type": "integer",
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    "snapshot": {
                        "type": "string",
                        "description": "The raw snapshot output text to search",
                    },
                    "query": {
                        "type": "string",
...
def browse_outline(name: str, args: dict[str, Any]) -> str:
    """Compress a browser_snapshot's accessibility tree into a compact outline."""
...
def browse_search(name: str, args: dict[str, Any]) -> str:
    """Search a browser_snapshot's text for a query pattern."""
    snapshot = args.get("snapshot", "")
